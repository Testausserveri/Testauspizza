            ...
            try {
                if (interaction.isCommand()) {
                    ...
                    switch (state.state) {
                        ...
                        case 'ordering': {
                            if (interaction.customId === "selectStore" && interaction.values && !state.shop) {
                            ...
                            if (interaction.customId === "selectPaymentMethod" && interaction.values && state.order) {
                                await orderModule.sendPaymentButton(state, interaction, db);
                                return;
                            }
                            break;
                        }
                    ...
                    switch (state.state) {
                        case "selection": {
                            ...
                            } else if (interaction.customId === "selectionCancel" && state.temp.currentProduct) {
                                productsActionsModule.cancelSelection(state, interaction, db);
                            }
                            break;
                        }
                        case 'ordering': {
